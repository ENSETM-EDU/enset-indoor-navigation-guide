...
const ToilettesPage: React.FC = () => {
  ...
  const handleGenderSelection = (gender: 'homme' | 'femme') => {
    ...
    const navigationId = `${pointDepartPascalCase}ToToilettes${genderSuffix}`;
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-left">
                    <h3 className="text-xl font-bold text-gray-900">Toilettes Hommes</h3>
                  </div>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-left">
                    <h3 className="text-xl font-bold text-gray-900">Toilettes Femmes</h3>
                  </div>
                </div>

...
const CeremoniePage: React.FC = () => {
  ...
  const ceremonieOptions = [
    { name: 'Cérémonie ENSAD', route: '/ensad/porte1', description: 'Accéder à la cérémonie ENSAD' },
    { name: 'Cérémonie ENSET', route: '/enset/porte2', description: 'Accéder à la cérémonie ENSET' },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-8">
      ...
      >
        ...
        >
          <span className="gradient-bg bg-clip-text text-transparent">Cérémonies de remise des diplômes</span>
        </motion.h1>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          {ceremonieOptions.map((option, index) => (
            <motion.div
              key={option.name}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
